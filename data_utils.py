...
def create_dataset(en_sentences, de_sentences):
	...
	en_vocab = list(en_vocab)[:20000]
	de_vocab = list(de_vocab)[:30000]
...
def main():
	#en_sentences = read_sentences('data/data.en')#en
	#de_sentences = read_sentences('data/data.de')#de

	en_sentences = read_sentences(sys.argv[1])
	de_sentences = read_sentences(sys.argv[2])
